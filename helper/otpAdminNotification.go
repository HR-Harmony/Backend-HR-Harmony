...
func SendAdminPasswordResetOTP(userEmail string, fullname string, otp string, expiredAt time.Time) error {
...
// SendAdminPasswordChangedNotification mengirim notifikasi email bahwa password admin telah diubah
func SendAdminPasswordChangedNotification(userEmail string, fullname string) error {
	// Mengambil nilai dari environment variables
	smtpServer := os.Getenv("SMTP_SERVER")
	smtpPortStr := os.Getenv("SMTP_PORT")
	smtpUsername := os.Getenv("SMTP_USERNAME")
